...
if [[ -d $HOME/Downloads/pgilinux-2017-174_x86_64 ]]; then
...
if [[ -d $HOME/Downloads/l_mkl_2017.4.239 ]]; then
...
if [[ -d $HOME/Downloads/parallel_studio_xe_2018_update2_professional_edition ]]; then
...
if [[ -d $HOME/Downloads/hdf5-1.10.1 ]]; then
